...
# Interpret against India's WTP thresholds
wtp_1gdp <- 170000   # ~1x GDP per capita
wtp_3gdp <- 510000   # ~3x GDP per capita

if (icer < wtp_1gdp) {
  cat("DES is HIGHLY cost-effective")
} else if (icer < wtp_3gdp) {
  cat("DES is cost-effective")
} else {
  cat("DES is NOT cost-effective")
}
```
...
- **ICER comparison** against WTP threshold
