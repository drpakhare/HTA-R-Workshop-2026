---
title: "Session 3: Diagnostic Decision Tree — Gestational Diabetes Screening"
subtitle: "Universal vs risk-based screening for GDM in India"
format:
  html:
    toc: true
    code-fold: show
...
cat("=== Incremental Cost-Effectiveness Ratios ===\n\n")
cat("Risk-Based vs No Screening:\n")
cat("  Incremental cost: ₹", format(round(inc_cost_risk_vs_none), big.mark = ","), "\n")
cat("  Incremental QALYs:", round(inc_qaly_risk_vs_none, 2), "\n")
cat("  ICER: ₹", format(round(icer_risk_vs_none), big.mark = ","), "per QALY\n\n")

cat("Universal vs No Screening:\n")
cat("  Incremental cost: ₹", format(round(inc_cost_univ_vs_none), big.mark = ","), "\n")
cat("  Incremental QALYs:", round(inc_qaly_univ_vs_none, 2), "\n")
cat("  ICER: ₹", format(round(icer_univ_vs_none), big.mark = ","), "per QALY\n\n")

cat("Universal vs Risk-Based:\n")
cat("  Incremental cost: ₹", format(round(inc_cost_univ_vs_risk), big.mark = ","), "\n")
cat("  Incremental QALYs:", round(inc_qaly_univ_vs_risk, 2), "\n")
cat("  ICER: ₹", format(round(icer_univ_vs_risk), big.mark = ","), "per QALY\n")
```
...
→ **Next:** Open `gdm-exercise.qmd` to practice modifying this model yourself.
